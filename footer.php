        ...
        <div class="row footer-inner">
            ...
            <div class="col-sm-3">
                ...
                <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item"><a class="nav-link px-3 link-light" href="login.php">Login</a></li>
                    <li class="nav-item"><a class="nav-link px-3 link-light" href="signup.php">Signup</a></li>
                    <li class="nav-item"><a class="nav-link px-3 link-light" href="#">About</a></li>
                </ul>
            </div>
